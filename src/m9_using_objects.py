...
def two_circles():
    ...
    circle1 = rg.Circle(rg.Point(200, 300), 25)
    circle1.fill_color = 'orange'
    circle1.attach_to(window)
    circle2 = rg.Circle(rg.Point(200, 103), 100)
...
def circle_and_rectangle():
    ...
    rectangle = rg.Rectangle(rg.Point(350, 350), rg.Point(200, 50))
...
def lines():
    ...
    window = rg.RoseWindow(400, 400)
    line1 = rg.Line(rg.Point(150, 10), rg.Point(375, 280))
    line1.thickness = 25
    line1.attach_to(window)
    line2 = rg.Line(rg.Point(50, 400), rg.Point(250, 250))

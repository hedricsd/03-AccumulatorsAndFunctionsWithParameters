...
#            Updates window with new shapes
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            Whenever you want the window to stay open after it is done coding
#            So you can see the picture for a longer time
#
...
#   change the above _TO_DO_ to DONE.
#
###############################################################################
